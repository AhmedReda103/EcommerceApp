...
class AddressViewModel @Inject constructor(
    ...
    fun addAddress(address: Address) {
        ...
        if(validateInputs){
            ...
            viewModelScope.launch {
                ...
                //_addAddress.emit(Resource.Error("all fiels are required "))
            }
        }
    }
    ...
    private fun validateInputs(address: Address): Boolean {
        return address.addressTitle.trim().isNotEmpty() && address.city.trim()
            .isNotEmpty() && address.phone.trim().isNotEmpty() && address.state.trim()
            .isNotEmpty() && address.fullName.trim().isNotEmpty() && address.street.trim().isNotEmpty()
